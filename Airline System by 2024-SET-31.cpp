...
public:
    ...
    void addFlight() {
        ...
        cout << "Enter Flight type (1.Domestic, 2.International, 3.Charter): ";
        int choice; 
        cin >> choice;
        ...
        if (choice == 1) {
            flights.push_back(unique_ptr<DomesticFlight>(new DomesticFlight(fn, o, d, dt, seats)));                                                                              cout << "Visa/Entry Fee: ";
            cin >> fee;
            flights.push_back(unique_ptr<InternationalFlight>(new InternationalFlight(fn, o, d, dt, seats, fee)));
        } else if (choice == 3) {
            cout << "Contract Holder Name: ";
            cin >> ws;
            getline(cin, contract);
            flights.push_back(unique_ptr<CharterFlight>(new CharterFlight(fn, o, d, dt, seats, contract)));
        } else { 
